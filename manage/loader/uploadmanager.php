...
window.onload = function() {
	...
	swfu = new SWFUpload({
		...
		upload_script : "../../uploadmanager.php?id=<?=$_GET['id']?>&action=upload",
...
<body>
<h2 style="font-family:Arial, Helvetica, sans-serif; font-size:18px; border-bottom:1px solid #CCC;">Upload Your Images</h2>
