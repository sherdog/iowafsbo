...
class com.mammon.swfupload.SWFUpload
{
	...
	// Private variables
	private var controlId:Number = 0; //Math.floor(Math.random() * 10000) + 1;
	private var currentFile:FileReference = null;
	private var currentFileId:Number = 0;
	private var fileList:FileReferenceList = null; //new FileReferenceList();
	...
	private var uploadIntervalId:Number = null;
	...
	*/
	private function upload():Void {
		...
		if(uploadIntervalId != null)	clearInterval(uploadIntervalId);
	...
	*/
	public function uploadSelect(fileRefList:FileReferenceList):Void 
	{
		...
		if (autoUpload == "true")
			uploadIntervalId = setInterval(this, "upload", 125);//upload();
	};
	...
	*/
	private function fileComplete():Void 
	{
		...
		//upload();
		uploadIntervalId = setInterval(this, "upload", 125);
	};
