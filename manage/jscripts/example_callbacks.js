function fileQueued(file, queuelength) {
	...
	li.innerHTML = "<div id='" + file.id + " titleField' class='fileListTitle'> " + file.name + "</div><div class='fileListProgressBar'><span class='progressBar' id='" + file.id + "progress'></span></div><div class='fileListCancelButton'><a id='" + file.id + "deletebtn' class='cancelbtn' href='javascript:swfu.cancelFile(\"" + file.id + "\");'><!-- IE --></a></div><br class='clr'>";
