...
window.onload = function() {
	swfu = new SWFUpload({
		upload_script : "/manage/uploadadd.php?action=upload&code=<?=$form_code?>&id=<?=$form_id?>&type=3&session=<?=$session?>",
...
<li class="active"><a  class="active"id="slideTab" href="#">Slideshow</a></li>
</ul></div><br>
...
switch($form_action) {
	...
	case "delete":
		...
		break;
	case "upload": ?>
		<a href='upload-slideshow.php?id=<?=$form_id?>&code=<?=$form_code?>'>Done uploading</a><br>
		...
		break;
	default:
		echo "<a href='upload-slideshow.php?action=upload&id=$form_id&code=$form_code'>Upload Slideshow</a><br>\n";
